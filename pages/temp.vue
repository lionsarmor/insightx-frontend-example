<template>
    <div class="wrapper">
        <div class="d-block text-center">
            <h3>Login</h3>
            <b-form-input ref="usernameLogin" type="text" placeholder="Enter username"></b-form-input><br>
            <b-form-input ref="passwordLogin" type="password" placeholder="Enter password"></b-form-input><br>
